...
impl CCodeGen {
    ...
    fn generate_header(&self, model: &Model) -> String {
        ...
        let input_size: i64 = model_info
            .input_shapes
            .first()
            .map_or(1, |shape| shape.iter().product());
...
impl CodeGenerator for CCodeGen {
    fn generate(&self, model: &Model, output_dir: &Path) -> Result<GeneratedCode> {
        ...
        Ok(GeneratedCode {
            implementation_file: impl_path.to_string_lossy().to_string(),
            ...
            dependencies: vec!["gcc".to_string(), "make".to_string()],
        })
    }
...
mod tests {
    ...
    fn create_test_model() -> Model {
        let info = ModelInfo {
            ...
            model_size_bytes: 200_000, // 200KB
